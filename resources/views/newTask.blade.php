...
<head>
    <title>meuagendamento - Incluir</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('/images/bg-01.jpg');">
            <div class="wrap-login100-3 p-t-30 p-b-50">
                ...
                <div class="container">
                    <form action="{{route('record_task')}}" method="POST">
                        @csrf
                        <div class="form-group">
                            <label>Compromisso</label>
                            <textarea class="form-control" placeholder="informe seu compromisso" name="compromisso" id="compromisso" rows="3" required></textarea>
                        </div>
                        <div class="form-group">
                            <label>Data</label>
                            <div>
